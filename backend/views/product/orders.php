...
$orders= Orderitems::find()->joinWith('order')->joinWith('product')->all();
$orders= Deliveryrecord::find()->joinWith('order')->joinWith('user')->all();
              ...
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>                    
                    ...
                    <td>
                      <a href="#" baseUrl="<?= Yii::$app->request->baseUrl?>" id="<?=$use->id?>" class="badge badge-pill btn-success px-3 py-2 orderupdate"> Confirm </a>
                    </td>
                  </tr>               
                 <?php } ?>
                </tbody>
