      ...
      <div class="card">
        <div class="card-body d-sm-flex justify-content-between">
          ...
          <h4 class="mb-2 mb-sm-0 pt-1">
            ...
            </h4>  <a href="<?= Url::to(['cashier/index'])?>" class="badge bg-danger p-2 text-white float-right">Back</a>   
        </div>
      </div>
    </section>
              ...
              <table id="datatable" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                    <a href="#" baseUrl="<?= Yii::$app->request->baseUrl?>" id="<?=$use->posId?>" class="badge badge-pill btn-success px-3 py-2 restore"> Restore </a>
                    </td>
                  </tr>            
                 <?php } ?>
                </tbody>
